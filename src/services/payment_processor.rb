module PaymentProcessor
  def self.distribute_revenue payment:, recording_claims:
    result = {}

    recording_claims.each do |recording_claim|
      license_agreement = recording_claim.license_agreement
      ...
      rh_total_revenue = recording_claim.claimed_percentage * payment.recording_revenues
